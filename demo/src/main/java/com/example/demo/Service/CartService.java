...
public List<Cartitem> getcart(String studentid){
 return  studentrepository.findById(Long.valueOf(studentid)).map(cartitemrepository::findByStudent).orElseGet(List::of);
}
}